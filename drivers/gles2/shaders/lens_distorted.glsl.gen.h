...
#ifndef LENS_DISTORTED_GLSL_GEN_HGLES2_120
#define LENS_DISTORTED_GLSL_GEN_HGLES2_120


#include "drivers/gles2/shader_gles2.h"


class LensDistortedShaderGLES2 : public ShaderGLES2 {

	 virtual String get_shader_name() const { return "LensDistortedShaderGLES2"; }
public:
